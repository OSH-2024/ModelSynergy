...
- [\<\<\<\<\<\<\< HEAD](#-head)
  ...
  - [随机微分方程与伊藤积分](#随机微分方程与伊藤积分-1)
    - [具体任务](#具体任务)
  - [利用RAY模拟求数值解](#利用ray模拟求数值解)
    - [利用RAY模拟求数值解](#利用ray模拟求数值解-1)
    - [利用RAY模拟求数值解](#利用ray模拟求数值解-2)
  - [部署RAY](#部署ray)
    - [单机部署](#单机部署)
      - [部署运行](#部署运行)
      - [单机部署优化](#单机部署优化)
...
>>>>>>> 8b4f8239d74afb9e03111af5ae11d0f1fb3f18c7
这里，
- \( X_t \) 是随时间 \( t \) 变化的随机过程，
...
<<<<<<< HEAD
>>>>>>> 1821d52d536e720fa6cd26beb055c7977b1b9ab0
=======
>>>>>>> 8b4f8239d74afb9e03111af5ae11d0f1fb3f18c7
